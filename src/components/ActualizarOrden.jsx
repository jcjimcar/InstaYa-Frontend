        ...
        <main>
            ...
            <div >
                <form className="formRegistro" action="">
                    <div >
                        <div className="divH1" ><h3 >Actualizar Orden de Servicio</h3></div>
                    </div>
        ...
        <aside className="formContenedorImagen">
            <div className="formImagen" style={{display:"grid"}} >
                <div style={{display:"flex", transform:"translate(18%,-50%)"}} >
                    <img src="../images/img_actualizar2.jpg" alt="Registro de usuario" width="150" height="150" />
                ...
                <div>
                    <img src="../images/img_actualizar.jpg" alt="Actualizar orden de servicio" width="550" height="450" />
                </div>
